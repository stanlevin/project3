...
<head>
    <title>Switch Law - Edit Case</title>
    <meta charset="utf-8">
    ...
    <div class="container-fluid" id="dashboard">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <h3 class="text-center mt-2" id="welcome">Edit Case</h3>
                ...
                <div class="shadow-lg p-3 mb-3 bg-white rounded mt-md-2">
                    ...
                    <form id="editcaseForm" class="" action="dheditcase.php" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="case_name" value="<?php echo $data[$id]['case_name']?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="case_type" value="<?php echo $data[$id]['case_type']?>" required>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="date" class="form-control" name="submission_date" value="<?php echo $data[$id]['submission_date']?>">
                                    </div>
                                </div>
                            </div>
